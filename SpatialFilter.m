...
%% 1) extract ROI
clear, clc, %close all
fname='/Users/joshyv/Research/data/rafa/brendon/last_2_weeks/080218a/080218a24.tif';
ROWS=[55 75];
COLS=[65 80];
% MovInf=imfinfo(fname);
for i=1:284 % we get this number from knowing how long the ephys lasted. numel(MovInf)
