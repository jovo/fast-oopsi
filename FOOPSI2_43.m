function [n P]=FOOPSI2_43(F,P,Sim)
...
M   = spdiags([-P.gam*O O]/P.rho, -1:0,T-1,T-1); % matrix transforming calcium into spikes, ie n=M*C
...
d1  = 2:T:(T-1)^2;                              % index of off-diagonal elements (the diagonal below the diagonal) of TxT matrices
