...
if ~isfield(Sim,'MaxIter'), Sim.MaxIter=0; end % determine number of interations, if not declared, set to 0
% if ~isfield(Sim,'T') T=length(F); else T=Sim.T; end % set length
