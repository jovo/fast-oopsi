...
\input{tex/main_result}

%\clearpage\newpage
%\subsubsection{Comparison with Wiener filter}
%\input{tex/wiener}
...
\input{tex/nonlin_obs}

\clearpage\newpage
\subsection{Dynamic prior}
\input{tex/dynamic_prior}
