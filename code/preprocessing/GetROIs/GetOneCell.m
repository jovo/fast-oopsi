...
%     try
        ...
        a=normalize(a,1,60);
            ...
            drawnow
%         range=[344:356, 368:375];
%         a_crop=a(344:356, 368:375);
%         siz=prod(size(range));
%         F(1,n)=sum(sum(a_crop))/siz;
%         
%         range=[160:163, 14:17];
%         a_crop=a(160:163, 14:17);
%         siz=prod(size(range));
%         F(2,n)=sum(sum(a_crop))/siz;
%         
%         range=[134:138, 18:22];
%         a_crop=a(134:138, 18:22);
%         siz=prod(size(range));
%         F(3,n)=sum(sum(a_crop))/siz;
%         
%         range=[175:179, 15:19];
%         a_crop=a(175:179, 15:19);
%         siz=prod(size(range));
%         F(4,n)=sum(sum(a_crop))/siz;
%         
%         
%         %     a_cat=a_crop(:);
%         %     Cells(:,n-1)=a_cat;
